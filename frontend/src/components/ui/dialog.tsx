...
function DialogTitle({
	...
	return (
		<DialogPrimitive.Title
			...
			className={cn('text-lg text-text-800 leading-none font-semibold', className)}
			{...props}
		/>
	);
}
